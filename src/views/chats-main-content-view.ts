...
class ChatsMainContentView extends View {
  ...
  build(): void {
    ...
    const $imageInputContainer = $('div', ['form__image-input-container', 'form-avatar__image-input-container11']);
  ...
  createMessageItem(message_: RenderedPersonalMessage & { profile: Profile }): HTMLLIElement {
    ...
    const { id, username, message, date, responsedToMessage, img } = message_;
