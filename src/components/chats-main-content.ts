...
class ChatsMainContentComponent extends Controller<ChatsMainContentView> {
  ...
  handleSendMessage = async (
    ...
    formData.append('fromUserId', appStore.user.id);
    formData.append('toUserId', this.chat.userId);
    ...
    //   img: img1,
    // };
    await appStore.addPersonalMessage(formData);
    emitPersonalMessage(formData);
  };
